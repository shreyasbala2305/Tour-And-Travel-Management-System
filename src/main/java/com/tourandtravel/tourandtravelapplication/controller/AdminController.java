...
import com.tourandtravel.tourandtravelapplication.model.Itinerary;
...
//     redirectAttributes.addFlashAttribute("success", "Tour package saved successfully");
     ...
     if (tourPackage.getItinerariesText() != null && !tourPackage.getItinerariesText().isEmpty()) {
         List<Itinerary> itineraryList = new ArrayList<>();
         String[] lines = tourPackage.getItinerariesText().split("\n");
...
//     public String saveTourPackage(@ModelAttribute TourPackage tourPackage) {
         // Parse the itinerariesText and create actual Itinerary objects
...
//     }
 ...
 public String editDestinationForm(@PathVariable("id") Long id, Model model) {
